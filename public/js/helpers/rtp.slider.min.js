...
(function (jQuery)
{
	...
	/*var resize_defer = jQuery.browser.msie &&
        ...
        // jquery dropped support for .browser var. test against useragent instead
        var resize_defer = navigator.userAgent.match(/MSIE 8/);
	...
	var firefox_overflow = navigator.userAgent.match(/Firefox/);;
